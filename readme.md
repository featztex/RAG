...
_!!! В данный момент бот не хостится на сервере, поэтому доступ к нему ограничен !!!_
...
1. Работа с ботом начинается с команды `/start`

<img src="bot_images/1.jpg" width="500" height="auto">

2. Затем бот задаст 4 вопроса по поводу настройки его работы. Параметры ровно те же, что и при использовании команды `start_dialogue`

<img src="bot_images/2.jpg" width="500" height="auto">

3. После этого будет выведено сообщение с установленными параметрами, а предыдущие сообщения о настройке бота будут удалены

<img src="bot_images/3.jpg" width="500" height="auto">

4. Далее бот переходит в уже привычный диалоговый режим

<img src="bot_images/4.jpg" width="500" height="auto">

5. Остановить работу бота можно с помощью команды `/end`
